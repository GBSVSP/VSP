...
public static String GET_A1_FORMS = "select REFERENCE_NO,A1_REF_NO,A1_STATUS_ID,A1_COMPLETE_DATE,A1_MANAGER,NEXT_STEP, "
		...
		+ "CREATED_BY,MODIFICATION_DATE, MODIFIED_BY from a1_workshop_info where IS_DELETE='N' and REFERENCE_NO=? order by A1_REF_NO desc";
//get A1 history
...
/** A23 Workshop Form Queries **/

//check existing A23 workshop
public static String COUNT_A23 ="Select count(WORKSHOP_REF_NUMBER) from A23_WORKSHOP_INFO where ";

//inserting A23 workshop
public static String INSERT_A23_WORKSHOP = "Insert into A23_WORKSHOP_INFO (REFERENCE_NO, WORKSHOP_REF_NUMBER, WORKSHOP_COMPLETE_DATE, DEAL_COACH,"
		+ "WORKSHOP_STATUS, WORKSHOP_LENGTH, DEAL_COACHING_EVALUATION, DEAL_COACHING_EVALUATION_JUSTIFICATION,"
		+ "SHOULD_WE_SELL_SCORE, CAN_WE_SELL_SCORE, PURSUIT_PROFILER_WIN_CHANCE, EVALUATION,"
		+ "BRIEFING_CALL_HELD_DATE, NEXT_FOLLOW_UP_CALL_DATE, MODULES_RUN, IBM_BELOVED_DEAL_FLAG,"
		+ "ANTICIPATE_POWER_BASE1, ANTICIPATE_POWER_BASE2, ACTUAL_POWER_BASE, ANTICIPATED_COMPETITORS1, ANTICIPATED_COMPETITORS2, ACTUAL_COMPETITORS,"
		+ "CLIENT_ATTENDED, CONSORTIUM, CREATED_BY) "
		+ "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";

//update A23 workshop
public static String UPDATE_A23_WORKSHOP = "Update A23_WORKSHOP_INFO set WORKSHOP_COMPLETE_DATE =?, DEAL_COACH =?,"
		+ "WORKSHOP_STATUS =?, WORKSHOP_LENGTH =?, DEAL_COACHING_EVALUATION =?, DEAL_COACHING_EVALUATION_JUSTIFICATION =?,"
		+ "SHOULD_WE_SELL_SCORE =?, CAN_WE_SELL_SCORE =?, PURSUIT_PROFILER_WIN_CHANCE =?, EVALUATION =?,"
		+ "BRIEFING_CALL_HELD_DATE =?, NEXT_FOLLOW_UP_CALL_DATE =?, MODULES_RUN =?, IBM_BELOVED_DEAL_FLAG =?,"
		+ "ANTICIPATE_POWER_BASE1 =?, ANTICIPATE_POWER_BASE2 =?, ACTUAL_POWER_BASE =?, ANTICIPATED_COMPETITORS1 =?, "
		+ "ANTICIPATED_COMPETITORS2 =?, ACTUAL_COMPETITORS =?, CLIENT_ATTENDED =?, CONSORTIUM =?, MODIFIED_BY =? where";

//get A23 Forms
public static String GET_A23_FORMS = "select REFERENCE_NO, WORKSHOP_REF_NUMBER, WORKSHOP_COMPLETE_DATE, DEAL_COACH, WORKSHOP_STATUS, WORKSHOP_LENGTH,"
		+ "DEAL_COACHING_EVALUATION, DEAL_COACHING_EVALUATION_JUSTIFICATION, SHOULD_WE_SELL_SCORE, CAN_WE_SELL_SCORE, PURSUIT_PROFILER_WIN_CHANCE, "
		+ "EVALUATION, BRIEFING_CALL_HELD_DATE, NEXT_FOLLOW_UP_CALL_DATE, MODULES_RUN, IBM_BELOVED_DEAL_FLAG, ANTICIPATE_POWER_BASE1, "
		+ "ANTICIPATE_POWER_BASE2, ACTUAL_POWER_BASE, ANTICIPATED_COMPETITORS1, ANTICIPATED_COMPETITORS2, ACTUAL_COMPETITORS, CLIENT_ATTENDED, "
		+ "CONSORTIUM, CREATION_DATE, CREATED_BY, MODIFICATION_DATE, MODIFIED_BY, IS_DELETE "
		+ "from A23_WORKSHOP_INFO where REFERENCE_NO=? order by WORKSHOP_REF_NUMBER desc";

//get A23 history
public static String A23_HISTORY = "select WORKSHOP_REF_NUMBER from A23_WORKSHOP_INFO where REFERENCE_NO=? and  ";}

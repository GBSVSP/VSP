...
public static String COUNT_A23 ="Select count(WORKSHOP_REF_NO) from A23_WORKSHOP_INFO where ";
...
public static String INSERT_A23_WORKSHOP = "Insert into A23_WORKSHOP_INFO (REFERENCE_NO, WORKSHOP_REF_NUMBER, WORKSHOP_COMPLETE_DATE, DEAL_COACH,"
		...
		+ "CLIENT_ATTENDED, CONSORTIUM, CREATED_BY, IS_DELETE) "
		+ "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
...
//get A23 Forms
public static String GET_A23_FORMS = "select REFERENCE_NO, WORKSHOP_REF_NO, WORKSHOP_COMPLETE_DATE, DEAL_COACH, WORKSHOP_STATUS, WORKSHOP_LENGTH,"
		...
		+ "from A23_WORKSHOP_INFO where REFERENCE_NO=? order by WORKSHOP_REF_NO desc";

//get A23 history
public static String A23_HISTORY = "select WORKSHOP_REF_NO from A23_WORKSHOP_INFO where REFERENCE_NO=? and  ";}

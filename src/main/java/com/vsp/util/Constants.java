...
public static final String DEFAULT_SEARCH_TYPE = "CLIENT";
public static final String REFERENCE_NO_SQL = "REFERENCE_NO=?";
public static final String REFERENCE_NO_LIKE = "REFERENCE_NO like ?";
public static final String CLIENT_SQL = "CUSTOMER_NAME=?";
public static final String CLIENT_LIKE = "CUSTOMER_NAME like ?";
public static final String DEAL_SQL = "REFERENCE_NO=?";
public static final String SALES_CONNECT_NO_SQL="SALES_CONNECT_NO=?";
public static final String SALES_CONNECT_NO_LIKE="SALES_CONNECT_NO like ?";

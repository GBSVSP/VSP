...
public class SelectList {
	...
	// Populating workshop status drop down
	public ArrayList<SelectItem> getWorkshopStatusList() {
		whereClause = Constants.WORKSHOP_STATUS;
		String sql = QueryBuilder.SELECT_OPTION + "" + whereClause;
		ArrayList<SelectItem> optionList = new ArrayList<SelectItem>();
		try {
			optionMap = FormDAO.getOptionList(sql);
	...
	// Populating workshop length drop down
	public ArrayList<SelectItem> getLengthList() {
		whereClause = Constants.WORKSHOP_LENGTH;
		String sql = QueryBuilder.SELECT_OPTION + "" + whereClause;
		ArrayList<SelectItem> optionList = new ArrayList<SelectItem>();
		try {
			optionMap = FormDAO.getOptionList(sql);
	...
	// Populating deal coaching evaluation drop down
	public ArrayList<SelectItem> getDealCoachingEvaluationList() {
		whereClause = Constants.WORKSHOP_DEAL_COACHING_EVALUATION;
		String sql = QueryBuilder.SELECT_OPTION + "" + whereClause;
		ArrayList<SelectItem> optionList = new ArrayList<SelectItem>();
		try {
			optionMap = FormDAO.getOptionList(sql);
	...
	// Populating Evaluation drop down
	public ArrayList<SelectItem> getEvaluationList() {
		whereClause = Constants.WORKSHOP_EVALUATION_CONDITION;
		String sql = QueryBuilder.SELECT_OPTION + "" + whereClause;
		ArrayList<SelectItem> optionList = new ArrayList<SelectItem>();
		try {
			optionMap = FormDAO.getOptionList(sql);
	...
	// Populating Modules Run drop down
		public ArrayList<SelectItem> getModulesRunList() {
			whereClause = Constants.WORKSHOP_MODULES_RUN;
			String sql = QueryBuilder.SELECT_OPTION + "" + whereClause;
			ArrayList<SelectItem> optionList = new ArrayList<SelectItem>();
			try {
				optionMap = FormDAO.getOptionList(sql);

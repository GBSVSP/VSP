...
private String vSP_Document_Link ;
...
public String getVSP_Ref_No() {
	return vSP_Ref_No;
}
public void setVSP_Ref_No(String vSP_Ref_No) {
	this.vSP_Ref_No = vSP_Ref_No;
}
...
public String getSales_Connect_Opp_No() {
	return sales_Connect_Opp_No;
}
public void setSales_Connect_Opp_No(String sales_Connect_Opp_No) {
	this.sales_Connect_Opp_No = sales_Connect_Opp_No;
}
...
public String getVSP_Document_Link() {
	return vSP_Document_Link;
}
public void setVSP_Document_Link(String vSP_Document_Link) {
	this.vSP_Document_Link = vSP_Document_Link;
}
...
public void setOpp_Business_Partners(String opp_Business_Partners) {
	this.opp_Business_Partners = opp_Business_Partners;
}
public String getOpp_Close_Date() {
	return opp_Close_Date;
}
public void setOpp_Close_Date(String opp_Close_Date) {
	this.opp_Close_Date = opp_Close_Date;
}
